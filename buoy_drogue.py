...
def drogue(sel, gdt, dirfl):
    # This function filters and extracts specific oceanographic buoy data
    # based on whether the drogue (a sea anchor attached to a buoy) is active
    # or lost.
    ...
    for row in dirfl:
        ...
        if (sel > 0): # drogue on buoys selected
            ...
            if (drogue_off_date > 0 and end_date > gdt):
